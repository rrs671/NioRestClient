...
public class PostScheduledRequestStrategy implements ScheduledRequestStrategy {

    public <T, R> Future<T> postScheduled(ExecutorService executor, Semaphore semaphore, RestClient restClient, RequestParams params, R body, Class<T> clazz, String url) {
