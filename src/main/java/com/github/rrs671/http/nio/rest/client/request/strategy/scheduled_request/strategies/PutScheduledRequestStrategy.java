...
public class PutScheduledRequestStrategy implements ScheduledRequestStrategy {

    public <T, R> Future<T> putScheduled(ExecutorService executor, Semaphore semaphore, RestClient restClient, RequestParams params, R body, Class<T> clazz, String url) {
