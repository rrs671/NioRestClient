...
public class GetRequestStrategy implements RequestStrategy {
    ...
    public <T> CompletableFuture<T> getRequest(ExecutorService executor, Semaphore semaphore, RestClient restClient, RequestParams params, Class<T> clazz, String url) {
